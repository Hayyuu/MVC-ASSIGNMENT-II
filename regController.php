...
class regController{
	function create($firstname,$lastname,$username,$email,$password){
	$regmodel=new regModel();
	$regmodel->set_firstname($firstname);
	$regmodel->set_lastname($lastname);
	$regmodel->set_username($username);
	$regmodel->set_email($email);
	$regmodel->set_password($password);
